...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Saga Fabrics – Authentic Lucknowi Chikankari Suits Online',
    template: '%s',
  },
  description: 'Shop 100% pure cotton Lucknowi Chikankari & Handblock unstitched suit sets. Handcrafted artisanal embroidery, free express shipping across India.',
  keywords: [
    'Saga Fabrics',
    'Lucknowi Chikankari Suits Online',
    'Chikankari Unstitched Suit Sets',
    'Handblock Unstitched Suit Sets',
    'Pure Cotton Suits India',
    'Artisanal Chikankari Embroidery',
    'Jaipur Cotton Suit Material',
    'Buy Unstitched Suits Online India',
  ...
  openGraph: {
    ...
    title: 'Saga Fabrics – Authentic Lucknowi Chikankari Suits Online',
    description: 'Shop 100% pure cotton Lucknowi Chikankari & Handblock unstitched suit sets. Handcrafted artisanal embroidery, free express shipping across India.',
    images: [
      {
        url: LOGO_URL,
        width: 1200,
        height: 630,
        alt: 'Saga Fabrics – Authentic Lucknowi Chikankari Suits Online',
      },
    ],
  },
  twitter: {
